...
namespace KodlamaIoWorkshop.Business.Concretes
{
    public class CourseManager:ICourseService
    {
        ...
        public void Delete(DeleteCourseRequest deleteCourseRequest)
        {
            ...
            course.Id = deleteCourseRequest.Id;
            course.Description = deleteCourseRequest.Description;
            course.IsFree = deleteCourseRequest.IsFree;
            course.PictureUrl = deleteCourseRequest.PictureUrl;
